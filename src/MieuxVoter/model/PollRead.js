    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('proposals')) {
                obj['proposals'] = ApiClient.convertToType(data['proposals'], [ProposalRead]);
            }
            if (data.hasOwnProperty('grades')) {
                obj['grades'] = ApiClient.convertToType(data['grades'], [GradeRead]);
            }
...
/**
     ...
     * @return {Array.<module:MieuxVoter/model/ProposalRead>}
     */
    getProposals() {
     ...
     * @param {Array.<module:MieuxVoter/model/ProposalRead>} proposals A list of Proposals to judge, that MUST contain at least two proposals, and can have at most 256 proposals but that upper limit is arbitrary and may wildly vary after benchmark and discussion.
     */
...
/**
     ...
     * @return {Array.<module:MieuxVoter/model/GradeRead>}
     */
    getGrades() {
        return this.grades;
    }
     ...
     * @param {Array.<module:MieuxVoter/model/GradeRead>} grades A list of Grades that Participants may give to Proposals – That list MUST contain at least two Grades, and at most 16 (another arbitrary limit to discuss).
     */
    setGrades(grades) {
        this['grades'] = grades;
    }
