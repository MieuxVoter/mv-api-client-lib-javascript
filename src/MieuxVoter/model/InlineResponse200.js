    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [InvitationjsonldRead]);
            }
...
/**
     * @return {Array.<module:MieuxVoter/model/InvitationjsonldRead>}
     */
    getHydramember() {
    ...
    /**
     * @param {Array.<module:MieuxVoter/model/InvitationjsonldRead>} hydramember
     */
