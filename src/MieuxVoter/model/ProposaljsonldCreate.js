    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('poll')) {
                obj['poll'] = PolljsonldCreate.constructFromObject(data['poll']);
            }
        }
        return obj;
    }
...
/**
     * @return {module:MieuxVoter/model/PolljsonldCreate}
     */
    getPoll() {
        return this.poll;
    }
    ...
    /**
     * @param {module:MieuxVoter/model/PolljsonldCreate} poll
     */
    setPoll(poll) {
        this['poll'] = poll;
    }
...
export default ProposaljsonldCreate;
