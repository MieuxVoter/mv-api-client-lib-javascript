...
/**
     ...
     * @return {Array.<module:MieuxVoter/model/ProposalCreate>}
     */
    getProposals() {
     ...
     * @param {Array.<module:MieuxVoter/model/ProposalCreate>} proposals A list of Proposals to judge, that MUST contain at least two proposals, and can have at most 256 proposals but that upper limit is arbitrary and may wildly vary after benchmark and discussion.
     */
...
/**
     ...
     * @return {Array.<module:MieuxVoter/model/GradeCreate>}
     */
    getGrades() {
        return this.grades;
    }
     ...
     * @param {Array.<module:MieuxVoter/model/GradeCreate>} grades A list of Grades that Participants may give to Proposals – That list MUST contain at least two Grades, and at most 16 (another arbitrary limit to discuss).
     */
    setGrades(grades) {
        this['grades'] = grades;
    }
