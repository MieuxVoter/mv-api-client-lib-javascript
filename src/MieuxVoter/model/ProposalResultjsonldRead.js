 ...
 * @version 0.0.0-dev
 */
class ProposalResultjsonldRead {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('medianGrade')) {
                obj['medianGrade'] = GradejsonldRead.constructFromObject(data['medianGrade']);
            }
...
/**
     * @return {module:MieuxVoter/model/ProposaljsonldRead}
     */
    getProposal() {
    ...
    /**
     * @param {module:MieuxVoter/model/ProposaljsonldRead} proposal
     */
    setProposal(proposal) {
        this['proposal'] = proposal;
    }
/**
     * Returns The computed rank of the Proposal in the Poll — Rank starts at 1 and goes upwards, and two proposals may have the same rank.
     * @return {Number}
     */
    getRank() {
        return this.rank;
    ...
    /**
     * Sets The computed rank of the Proposal in the Poll — Rank starts at 1 and goes upwards, and two proposals may have the same rank.
     * @param {Number} rank The computed rank of the Proposal in the Poll — Rank starts at 1 and goes upwards, and two proposals may have the same rank.
     */
    setRank(rank) {
        this['rank'] = rank;
    }
/**
     * @return {module:MieuxVoter/model/GradejsonldRead}
     */
    getMedianGrade() {
    ...
    /**
     * @param {module:MieuxVoter/model/GradejsonldRead} medianGrade
     */
...
/**
     * Returns Results for each Grade, on this Proposal — This is the merit profile of the Proposal.
    ...
    /**
     * Sets Results for each Grade, on this Proposal — This is the merit profile of the Proposal.
     * @param {Array.<module:MieuxVoter/model/ProposalGradeResultRead>} gradesResults Results for each Grade, on this Proposal — This is the merit profile of the Proposal.
     */
...
export default ProposalResultjsonldRead;
