...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposaljsonldCreate();
  });
  ...
  describe('ProposaljsonldCreate', function() {
    it('should create an instance of ProposaljsonldCreate', function() {
      // uncomment below and update the code to test ProposaljsonldCreate
      //var instane = new MvApiClientLib.ProposaljsonldCreate();
      //expect(instance).to.be.a(MvApiClientLib.ProposaljsonldCreate);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.ProposaljsonldCreate();
