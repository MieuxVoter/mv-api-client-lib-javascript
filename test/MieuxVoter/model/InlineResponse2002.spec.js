...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse2002();
  });
  ...
  describe('InlineResponse2002', function() {
    it('should create an instance of InlineResponse2002', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse2002();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse2002);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse2002();
