...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserEdit();
  });
  ...
  describe('UserEdit', function() {
    it('should create an instance of UserEdit', function() {
      ...
      //var instane = new MvApiClientLib.UserEdit();
      //expect(instance).to.be.a(MvApiClientLib.UserEdit);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new MvApiClientLib.UserEdit();
