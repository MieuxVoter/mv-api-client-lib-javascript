...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse2001();
  });
  ...
  describe('InlineResponse2001', function() {
    it('should create an instance of InlineResponse2001', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse2001();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse2001);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse2001();
