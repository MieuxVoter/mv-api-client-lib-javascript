...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.GradeCreate();
  });
  ...
  describe('GradeCreate', function() {
    it('should create an instance of GradeCreate', function() {
      // uncomment below and update the code to test GradeCreate
      //var instane = new MvApiClientLib.GradeCreate();
      //expect(instance).to.be.a(MvApiClientLib.GradeCreate);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new MvApiClientLib.GradeCreate();
