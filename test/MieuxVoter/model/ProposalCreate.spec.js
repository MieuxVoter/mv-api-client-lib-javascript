...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalCreate();
  });
  ...
  describe('ProposalCreate', function() {
    it('should create an instance of ProposalCreate', function() {
      // uncomment below and update the code to test ProposalCreate
      //var instane = new MvApiClientLib.ProposalCreate();
      //expect(instance).to.be.a(MvApiClientLib.ProposalCreate);
    });

    it('should have the property title (base name: "title")', function() {
      // uncomment below and update the code to test the property title
      //var instance = new MvApiClientLib.ProposalCreate();
