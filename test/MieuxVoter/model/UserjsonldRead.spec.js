...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserjsonldRead();
  });
  ...
  describe('UserjsonldRead', function() {
    it('should create an instance of UserjsonldRead', function() {
      // uncomment below and update the code to test UserjsonldRead
      //var instane = new MvApiClientLib.UserjsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.UserjsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.UserjsonldRead();
