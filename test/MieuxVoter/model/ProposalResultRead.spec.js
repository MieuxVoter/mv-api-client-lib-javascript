...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalResultRead();
  });
  ...
  describe('ProposalResultRead', function() {
    it('should create an instance of ProposalResultRead', function() {
      // uncomment below and update the code to test ProposalResultRead
      //var instane = new MvApiClientLib.ProposalResultRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposalResultRead);
    });
    ...
    it('should have the property proposal (base name: "proposal")', function() {
      ...
      //var instance = new MvApiClientLib.ProposalResultRead();
