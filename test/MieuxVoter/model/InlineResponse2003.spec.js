...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse2003();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse2003);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse2003();
