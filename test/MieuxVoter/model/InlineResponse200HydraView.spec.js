...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse200HydraView();
  });
  ...
  describe('InlineResponse200HydraView', function() {
    it('should create an instance of InlineResponse200HydraView', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse200HydraView();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse200HydraView);
    });

    it('should have the property id (base name: "@id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MvApiClientLib.InlineResponse200HydraView();
