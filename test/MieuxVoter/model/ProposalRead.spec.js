...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalRead();
  });
  ...
  describe('ProposalRead', function() {
    it('should create an instance of ProposalRead', function() {
      // uncomment below and update the code to test ProposalRead
      //var instane = new MvApiClientLib.ProposalRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposalRead);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.ProposalRead();
