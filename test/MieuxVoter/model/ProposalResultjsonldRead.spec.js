...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalResultjsonldRead();
  });
  ...
  describe('ProposalResultjsonldRead', function() {
    it('should create an instance of ProposalResultjsonldRead', function() {
      // uncomment below and update the code to test ProposalResultjsonldRead
      //var instane = new MvApiClientLib.ProposalResultjsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposalResultjsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.ProposalResultjsonldRead();
    ...
    it('should have the property medianGrade (base name: "medianGrade")', function() {
      // uncomment below and update the code to test the property medianGrade
      //var instance = new MvApiClientLib.ProposalResultjsonldRead();
      //expect(instance).to.be();
    });
    ...
    it('should have the property gradesResults (base name: "gradesResults")', function() {
      // uncomment below and update the code to test the property gradesResults
      //var instance = new MvApiClientLib.ProposalResultjsonldRead();
      //expect(instance).to.be();
    });
