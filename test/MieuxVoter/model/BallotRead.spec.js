...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotRead();
  });
  ...
  describe('BallotRead', function() {
    it('should create an instance of BallotRead', function() {
      // uncomment below and update the code to test BallotRead
      //var instane = new MvApiClientLib.BallotRead();
      //expect(instance).to.be.a(MvApiClientLib.BallotRead);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.BallotRead();
