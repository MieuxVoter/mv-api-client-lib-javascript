...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalGradeResultRead();
  });
  ...
  describe('ProposalGradeResultRead', function() {
    it('should create an instance of ProposalGradeResultRead', function() {
      // uncomment below and update the code to test ProposalGradeResultRead
      //var instane = new MvApiClientLib.ProposalGradeResultRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposalGradeResultRead);
    });

    it('should have the property grade (base name: "grade")', function() {
      // uncomment below and update the code to test the property grade
      //var instance = new MvApiClientLib.ProposalGradeResultRead();
