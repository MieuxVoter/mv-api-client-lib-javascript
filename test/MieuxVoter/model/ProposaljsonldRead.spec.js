...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposaljsonldRead();
  });
  ...
  describe('ProposaljsonldRead', function() {
    it('should create an instance of ProposaljsonldRead', function() {
      // uncomment below and update the code to test ProposaljsonldRead
      //var instane = new MvApiClientLib.ProposaljsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposaljsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.ProposaljsonldRead();
