...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.GradeRead();
  });
  ...
  describe('GradeRead', function() {
    it('should create an instance of GradeRead', function() {
      // uncomment below and update the code to test GradeRead
      //var instane = new MvApiClientLib.GradeRead();
      //expect(instance).to.be.a(MvApiClientLib.GradeRead);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.GradeRead();
