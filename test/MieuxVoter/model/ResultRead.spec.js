...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ResultRead();
  });
  ...
  describe('ResultRead', function() {
    it('should create an instance of ResultRead', function() {
      // uncomment below and update the code to test ResultRead
      //var instane = new MvApiClientLib.ResultRead();
      //expect(instance).to.be.a(MvApiClientLib.ResultRead);
    });

    it('should have the property poll (base name: "poll")', function() {
      // uncomment below and update the code to test the property poll
      //var instance = new MvApiClientLib.ResultRead();
