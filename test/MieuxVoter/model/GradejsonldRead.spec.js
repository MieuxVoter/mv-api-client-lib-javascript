...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.GradejsonldRead();
  });
  ...
  describe('GradejsonldRead', function() {
    it('should create an instance of GradejsonldRead', function() {
      // uncomment below and update the code to test GradejsonldRead
      //var instane = new MvApiClientLib.GradejsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.GradejsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.GradejsonldRead();
