...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.GradejsonldCreate();
  });
  ...
  describe('GradejsonldCreate', function() {
    it('should create an instance of GradejsonldCreate', function() {
      // uncomment below and update the code to test GradejsonldCreate
      //var instane = new MvApiClientLib.GradejsonldCreate();
      //expect(instance).to.be.a(MvApiClientLib.GradejsonldCreate);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.GradejsonldCreate();
