...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse200();
  });
  ...
  describe('InlineResponse200', function() {
    it('should create an instance of InlineResponse200', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse200();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse200);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse200();
