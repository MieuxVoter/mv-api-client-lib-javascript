...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.Credentials();
  });
  ...
  describe('Credentials', function() {
    it('should create an instance of Credentials', function() {
      ...
      //var instane = new MvApiClientLib.Credentials();
      //expect(instance).to.be.a(MvApiClientLib.Credentials);
    });
    ...
    it('should have the property usernameOrEmail (base name: "usernameOrEmail")', function() {
      ...
      //var instance = new MvApiClientLib.Credentials();
