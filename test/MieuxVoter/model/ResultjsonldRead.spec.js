...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ResultjsonldRead();
  });
  ...
  describe('ResultjsonldRead', function() {
    it('should create an instance of ResultjsonldRead', function() {
      // uncomment below and update the code to test ResultjsonldRead
      //var instane = new MvApiClientLib.ResultjsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.ResultjsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.ResultjsonldRead();
