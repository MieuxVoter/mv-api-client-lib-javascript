...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse200HydraSearchHydraMapping();
  });
  ...
  describe('InlineResponse200HydraSearchHydraMapping', function() {
    it('should create an instance of InlineResponse200HydraSearchHydraMapping', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse200HydraSearchHydraMapping();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse200HydraSearchHydraMapping);
    });

    it('should have the property type (base name: "@type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new MvApiClientLib.InlineResponse200HydraSearchHydraMapping();
