...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse2004();
  });
  ...
  describe('InlineResponse2004', function() {
    it('should create an instance of InlineResponse2004', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse2004();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse2004);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse2004();
