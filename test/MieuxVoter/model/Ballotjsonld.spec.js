...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.Ballotjsonld();
  });
  ...
  describe('Ballotjsonld', function() {
    it('should create an instance of Ballotjsonld', function() {
      // uncomment below and update the code to test Ballotjsonld
      //var instane = new MvApiClientLib.Ballotjsonld();
      //expect(instance).to.be.a(MvApiClientLib.Ballotjsonld);
    });

    it('should have the property id (base name: "@id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new MvApiClientLib.Ballotjsonld();
