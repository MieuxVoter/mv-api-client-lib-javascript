...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalGradeResultjsonldRead();
  });
  ...
  describe('ProposalGradeResultjsonldRead', function() {
    it('should create an instance of ProposalGradeResultjsonldRead', function() {
      // uncomment below and update the code to test ProposalGradeResultjsonldRead
      //var instane = new MvApiClientLib.ProposalGradeResultjsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.ProposalGradeResultjsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.ProposalGradeResultjsonldRead();
