...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserjsonldEdit();
  });
  ...
  describe('UserjsonldEdit', function() {
    it('should create an instance of UserjsonldEdit', function() {
      // uncomment below and update the code to test UserjsonldEdit
      //var instane = new MvApiClientLib.UserjsonldEdit();
      //expect(instance).to.be.a(MvApiClientLib.UserjsonldEdit);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.UserjsonldEdit();
