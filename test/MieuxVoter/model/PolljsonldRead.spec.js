...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.PolljsonldRead();
  });
  ...
  describe('PolljsonldRead', function() {
    it('should create an instance of PolljsonldRead', function() {
      // uncomment below and update the code to test PolljsonldRead
      //var instane = new MvApiClientLib.PolljsonldRead();
      //expect(instance).to.be.a(MvApiClientLib.PolljsonldRead);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.PolljsonldRead();
    ...
    it('should have the property canGenerateInvitations (base name: "canGenerateInvitations")', function() {
      // uncomment below and update the code to test the property canGenerateInvitations
      //var instance = new MvApiClientLib.PolljsonldRead();
      //expect(instance).to.be();
    });
