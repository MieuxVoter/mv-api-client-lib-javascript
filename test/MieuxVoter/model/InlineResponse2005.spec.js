...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse2005();
  });
  ...
  describe('InlineResponse2005', function() {
    it('should create an instance of InlineResponse2005', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse2005();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse2005);
    });
    ...
    it('should have the property hydramember (base name: "hydra:member")', function() {
      ...
      //var instance = new MvApiClientLib.InlineResponse2005();
