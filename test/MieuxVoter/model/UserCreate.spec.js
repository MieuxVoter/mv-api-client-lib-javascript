...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserCreate();
  });
  ...
  describe('UserCreate', function() {
    it('should create an instance of UserCreate', function() {
      ...
      //var instane = new MvApiClientLib.UserCreate();
      //expect(instance).to.be.a(MvApiClientLib.UserCreate);
    });

    it('should have the property email (base name: "email")', function() {
      // uncomment below and update the code to test the property email
      //var instance = new MvApiClientLib.UserCreate();
