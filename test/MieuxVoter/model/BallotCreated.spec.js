...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotCreated();
  });
  ...
  describe('BallotCreated', function() {
    it('should create an instance of BallotCreated', function() {
      // uncomment below and update the code to test BallotCreated
      //var instane = new MvApiClientLib.BallotCreated();
      //expect(instance).to.be.a(MvApiClientLib.BallotCreated);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.BallotCreated();
