...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InlineResponse200HydraSearch();
  });
  ...
  describe('InlineResponse200HydraSearch', function() {
    it('should create an instance of InlineResponse200HydraSearch', function() {
      ...
      //var instane = new MvApiClientLib.InlineResponse200HydraSearch();
      //expect(instance).to.be.a(MvApiClientLib.InlineResponse200HydraSearch);
    });

    it('should have the property type (base name: "@type")', function() {
      // uncomment below and update the code to test the property type
      //var instance = new MvApiClientLib.InlineResponse200HydraSearch();
