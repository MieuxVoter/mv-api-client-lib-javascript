...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InvitationRead();
  });
  ...
  describe('InvitationRead', function() {
    it('should create an instance of InvitationRead', function() {
      ...
      //var instane = new MvApiClientLib.InvitationRead();
      //expect(instance).to.be.a(MvApiClientLib.InvitationRead);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.InvitationRead();
