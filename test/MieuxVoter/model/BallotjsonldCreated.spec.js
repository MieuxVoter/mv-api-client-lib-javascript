...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotjsonldCreated();
  });
  ...
  describe('BallotjsonldCreated', function() {
    it('should create an instance of BallotjsonldCreated', function() {
      // uncomment below and update the code to test BallotjsonldCreated
      //var instane = new MvApiClientLib.BallotjsonldCreated();
      //expect(instance).to.be.a(MvApiClientLib.BallotjsonldCreated);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.BallotjsonldCreated();
