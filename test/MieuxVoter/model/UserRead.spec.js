...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserRead();
  });
  ...
  describe('UserRead', function() {
    it('should create an instance of UserRead', function() {
      ...
      //var instane = new MvApiClientLib.UserRead();
      //expect(instance).to.be.a(MvApiClientLib.UserRead);
    });

    it('should have the property uuid (base name: "uuid")', function() {
      // uncomment below and update the code to test the property uuid
      //var instance = new MvApiClientLib.UserRead();
