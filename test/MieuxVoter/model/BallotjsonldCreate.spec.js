...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotjsonldCreate();
  });
  ...
  describe('BallotjsonldCreate', function() {
    it('should create an instance of BallotjsonldCreate', function() {
      // uncomment below and update the code to test BallotjsonldCreate
      //var instane = new MvApiClientLib.BallotjsonldCreate();
      //expect(instance).to.be.a(MvApiClientLib.BallotjsonldCreate);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.BallotjsonldCreate();
