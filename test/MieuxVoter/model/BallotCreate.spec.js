...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotCreate();
  });
  ...
  describe('BallotCreate', function() {
    it('should create an instance of BallotCreate', function() {
      // uncomment below and update the code to test BallotCreate
      //var instane = new MvApiClientLib.BallotCreate();
      //expect(instance).to.be.a(MvApiClientLib.BallotCreate);
    });

    it('should have the property grade (base name: "grade")', function() {
      // uncomment below and update the code to test the property grade
      //var instance = new MvApiClientLib.BallotCreate();
