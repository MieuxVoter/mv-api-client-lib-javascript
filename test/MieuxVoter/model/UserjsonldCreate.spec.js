...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserjsonldCreate();
  });
  ...
  describe('UserjsonldCreate', function() {
    it('should create an instance of UserjsonldCreate', function() {
      // uncomment below and update the code to test UserjsonldCreate
      //var instane = new MvApiClientLib.UserjsonldCreate();
      //expect(instance).to.be.a(MvApiClientLib.UserjsonldCreate);
    });

    it('should have the property context (base name: "@context")', function() {
      // uncomment below and update the code to test the property context
      //var instance = new MvApiClientLib.UserjsonldCreate();
