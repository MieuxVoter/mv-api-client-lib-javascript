...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.BallotApi();
  });
  ...
  describe('BallotApi', function() {
    ...
    describe('deleteBallotItem', function() {
      it('should call deleteBallotItem successfully', function(done) {
        //uncomment below and update the code to test deleteBallotItem
        //instance.deleteBallotItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getBallotItem', function() {
      it('should call getBallotItem successfully', function(done) {
        //uncomment below and update the code to test getBallotItem
        //instance.getBallotItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postBallotCollection', function() {
      it('should call postBallotCollection successfully', function(done) {
        //uncomment below and update the code to test postBallotCollection
        //instance.postBallotCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
