...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.InvitationApi();
  });
  ...
  describe('InvitationApi', function() {
    describe('getForPollInvitationCollection', function() {
      it('should call getForPollInvitationCollection successfully', function(done) {
        //uncomment below and update the code to test getForPollInvitationCollection
        //instance.getForPollInvitationCollection(function(error) {
