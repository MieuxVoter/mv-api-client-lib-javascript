...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.UserApi();
  });
  ...
  describe('UserApi', function() {
    ...
    describe('postCredentialsItem', function() {
      it('should call postCredentialsItem successfully', function(done) {
        //uncomment below and update the code to test postCredentialsItem
        //instance.postCredentialsItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putUserItem', function() {
      it('should call putUserItem successfully', function(done) {
        //uncomment below and update the code to test putUserItem
        //instance.putUserItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
