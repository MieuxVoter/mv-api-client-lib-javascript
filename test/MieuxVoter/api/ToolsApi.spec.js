...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ToolsApi();
  });
  ...
  describe('ToolsApi', function() {
    describe('getJsonResultFromTally', function() {
      it('should call getJsonResultFromTally successfully', function(done) {
        //uncomment below and update the code to test getJsonResultFromTally
        //instance.getJsonResultFromTally(function(error) {
    ...
    describe('getSvgMeritProfileFromTally', function() {
      it('should call getSvgMeritProfileFromTally successfully', function(done) {
        //uncomment below and update the code to test getSvgMeritProfileFromTally
        //instance.getSvgMeritProfileFromTally(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
