...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.GradeApi();
  });
  ...
  describe('GradeApi', function() {
    ...
    describe('getGradeItem', function() {
      it('should call getGradeItem successfully', function(done) {
        //uncomment below and update the code to test getGradeItem
        //instance.getGradeItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
