...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.ProposalApi();
  });
  ...
  describe('ProposalApi', function() {
    describe('apiPollsProposalsBallotsGetSubresource', function() {
      it('should call apiPollsProposalsBallotsGetSubresource successfully', function(done) {
        //uncomment below and update the code to test apiPollsProposalsBallotsGetSubresource
        //instance.apiPollsProposalsBallotsGetSubresource(function(error) {
    ...
    describe('apiProposalsBallotsGetSubresource', function() {
      it('should call apiProposalsBallotsGetSubresource successfully', function(done) {
        //uncomment below and update the code to test apiProposalsBallotsGetSubresource
        //instance.apiProposalsBallotsGetSubresource(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getProposalItem', function() {
      it('should call getProposalItem successfully', function(done) {
        //uncomment below and update the code to test getProposalItem
        //instance.getProposalItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postProposalCollection', function() {
      it('should call postProposalCollection successfully', function(done) {
        //uncomment below and update the code to test postProposalCollection
        //instance.postProposalCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
