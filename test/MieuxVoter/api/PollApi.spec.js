...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MvApiClientLib.PollApi();
  });
  ...
  describe('PollApi', function() {
    describe('apiPollsGradesGetSubresource', function() {
      it('should call apiPollsGradesGetSubresource successfully', function(done) {
        //uncomment below and update the code to test apiPollsGradesGetSubresource
        //instance.apiPollsGradesGetSubresource(function(error) {
    ...
    describe('apiPollsProposalsGetSubresource', function() {
      it('should call apiPollsProposalsGetSubresource successfully', function(done) {
        //uncomment below and update the code to test apiPollsProposalsGetSubresource
        //instance.apiPollsProposalsGetSubresource(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('deletePollItem', function() {
      it('should call deletePollItem successfully', function(done) {
        //uncomment below and update the code to test deletePollItem
        //instance.deletePollItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getForPollResultItem', function() {
      it('should call getForPollResultItem successfully', function(done) {
        //uncomment below and update the code to test getForPollResultItem
        //instance.getForPollResultItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPollCollection', function() {
      it('should call getPollCollection successfully', function(done) {
        //uncomment below and update the code to test getPollCollection
        //instance.getPollCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getPollItem', function() {
      it('should call getPollItem successfully', function(done) {
        //uncomment below and update the code to test getPollItem
        //instance.getPollItem(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('postPollCollection', function() {
      it('should call postPollCollection successfully', function(done) {
        //uncomment below and update the code to test postPollCollection
        //instance.postPollCollection(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
