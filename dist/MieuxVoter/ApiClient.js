...
* @alias module:MieuxVoter/ApiClient
* @class
*/
var ApiClient = /*#__PURE__*/function () {
  function ApiClient() {
     ...
     * @type {String}
     * @default https://oas.mieuxvoter.fr
     */
    this.basePath = 'https://oas.mieuxvoter.fr'.replace(/\/+$/, '');
    /**
  ...
  */
  ...
  _createClass(ApiClient, [{
    ...
    * @param {module:MieuxVoter/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
...
* @type {module:MieuxVoter/ApiClient}
*/
